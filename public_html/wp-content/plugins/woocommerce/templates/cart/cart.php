					...
					<td class="product-thumbnail">
						<?php
							...
							if ( ! $_product->is_visible() )
								...
								printf( '<a href="%s">%s</a>', get_home_url() . '/pricing-plans', $thumbnail );
						?>
					</td>
					...
					<td class="product-name">
						<?php
							if ( ! $_product->is_visible() )
								...
								echo apply_filters( 'woocommerce_cart_item_name', sprintf( '<a href="%s">%s</a>', get_home_url() . '/pricing-plans', $_product->get_title() ), $cart_item, $cart_item_key );
