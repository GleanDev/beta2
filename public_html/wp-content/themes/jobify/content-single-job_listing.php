...
<div class="single_job_listing" itemscope itemtype="http://schema.org/JobPosting">
	...
	<?php else : ?>
		...
		<div class="job-overview-content row">
			...
			<div itemprop="requirements" class="job-overview col-md-<?php echo $col_overview; ?> col-sm-12">
			<h2 class="job-overview-title">Requirements</h2>
			<?php echo get_post_meta( $post->ID, '_requirements', true ) ?>
			</div>
			
			<div itemprop="salary" class="job-overview col-md-<?php echo $col_overview; ?> col-sm-12">
			<h2 class="job-overview-title">Salary</h2>
