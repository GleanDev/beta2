...
*/
		...
		$fields['job']['job_location']['label'] = 'Pin your location <span class="job_field_description">Let job seekers nearby identify you</span>';
		$fields['job']['job_location']['required'] = 'true';
		$fields['job']['job_location']['description'] = '';

		$fields['job']['addr_details']['label'] = 'Full address <span class="job_field_description">Unit No, Street, Postcode, City</span>';

		$fields['job']['requirements']['label'] = 'Job Requirements <span class="job_field_description">Explain what the candidate must already have or know before applying</span>';

		$fields['job']['job_description']['label'] = 'Job Description <span class="job_field_description">Elaborate on the job scope and what is expected of the candidate when working for you</span>';

		$fields['job']['application']['label'] = 'Application Email/Url  <span class="job_field_description">Please fill in the email which you want candidates to email their applications to</span>';

		$fields['company']['company_description']['label'] = 'Description  <span class="job_field_description">Tell the candidates a little more about your nature of bussiness and what makes your company special.</span>';
		...
		FB::log($fields);
		/**
		 * Repea this for any additional fields.
		 */
	...
	function job_listing_data_fields( $fields ) {
		...
		$fields[ 'job_location' ]['label']='test'; 
...
if( !empty( $referrer ) && !strstr( $referrer,'wp-login' ) && !strstr( $referrer,'wp-admin' ) ) {
    wp_redirect( get_permalink( '1671' ) . "?login=failed" ); 
    exit;
}
